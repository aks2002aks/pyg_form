...
const UnverifiedResponseViewer = ({
  allUnVerifiedResponses,
}: {
  allUnVerifiedResponses: responses[];
}) => {
  ...
  return (
    <div className="bg-white container max-w-3xl rounded-xl  p-5">
      <div className="flex items-center justify-between">
        <div className="">Unverified Responses</div>
        <div
      ...
      {showResponses && (
        <div className="sm:p-5 pr-0 flex flex-col space-y-4">
          {allUnVerifiedResponses.map((response: responses, index: number) => {
            return (
              <div key={index}>
...
export default UnverifiedResponseViewer;
