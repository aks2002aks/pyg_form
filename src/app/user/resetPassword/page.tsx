    ...
    <div className="mx-auto flex w-full sm:max-w-md max-w-sm flex-col space-y-8 m-4">
      <div className="m-4 items-center justify-center">
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <div className="mt-6">
            <button
              className="w-full px-4 py-2 tracking-wide transition-colors duration-300 transform bg-gray-200 rounded-lg hover:bg-gray-300 focus:outline-none focus:bg-gray-400 focus:ring focus:ring-gray-300 focus:ring-opacity-50"
              type="submit"
            >
              Reset Password
            </button>
